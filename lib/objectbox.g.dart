...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 3764465783446823442),
      name: 'User',
      lastPropertyId: const IdUid(3, 3285393965152670978),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 5432456335503672490),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5512251040315997765),
            name: 'firstName',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 3285393965152670978),
            name: 'lastName',
            type: 9,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 3764465783446823442),
